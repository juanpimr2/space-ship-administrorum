...
public class SpaceShipController {
    ...
    @Operation(summary = "Modificar una nave espacial", description = "Modifica los detalles de una nave espacial existente.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Operación exitosa"),
            @ApiResponse(responseCode = "404", description = "Nave espacial no encontrada"),
            @ApiResponse(responseCode = "500", description = "Error interno del servidor")
    ...
    public ResponseEntity<SpaceShipResponse> updateSpaceShip(@PathVariable Long id, @RequestBody SpaceShipRequest spaceShip) {
        return spaceShipService.updateSpaceShip(id, spaceShip);
    }

    @Operation(summary = "Eliminar una nave espacial", description = "Elimina una nave espacial existente por su ID.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204", description = "Nave espacial eliminada"),
            @ApiResponse(responseCode = "404", description = "Nave espacial no encontrada"),
            @ApiResponse(responseCode = "500", description = "Error interno del servidor")
    })
